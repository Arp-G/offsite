defmodule Offsite.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Offsite.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    OffsiteWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
