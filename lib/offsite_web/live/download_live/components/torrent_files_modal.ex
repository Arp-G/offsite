defmodule OffsiteWeb.Components.TorrentFilesModal do
        ...
        <div class="w-full h-full border-2 bg-slate-200 overflow-auto">
          <table class="table-fixed w-full shadow">
            <thead class="sticky top-0 bg-slate-200">
              <tr>
                <th class="px-6 py-3 text-center text-xs text-gray-700 uppercase tracking-wider w-4">SL No</th>
                <th class="px-6 py-3 text-center text-xs text-gray-700 uppercase tracking-wider w-52">Filename</th>
                <th class="px-6 py-3 text-center text-xs text-gray-700 uppercase tracking-wider w-24">Progess</th>
                <th class="px-6 py-3 text-center text-xs text-gray-700 uppercase tracking-wider w-24">Actions</th>
              </tr>
            </thead>
  ...
  def action(file, assigns) do
    ...
    <div class="flex flex-row text-red justify-center gap-2">
      ...
      <%= if Helpers.playable_extention(file["name"]) do %>
